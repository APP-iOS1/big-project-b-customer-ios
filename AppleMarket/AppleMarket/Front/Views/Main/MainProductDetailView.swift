...
struct MainProductDetailView: View {
    ...
    let promotionProducts: [Product] = [
        Product(id: 0, imagePath: "https://www.apple.com/newsroom/images/product/ipad/standard/apple_ipad-pro-spring21_hero_04202021_big.jpg.large.jpg", productName: "iPad Pro", description: "최첨단 기술이 구현하는 궁극의 iPad 경험. 역대 가장 프로다운 iPad를 만나다. " ,prices: "1,249,000"),
        Product(id: 1, imagePath: "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/ipad-finish-unselect-gallery-2-202207_FMT_WHH?wid=1280&hei=720&fmt=p-jpg&qlt=95&.v=1654902551786", productName: "iPad(10세대)", prices: "1,249,000"),
    ]
